		<div class="thumbs thumbs_cat l<?php echo $tpl->getThumbLinesNumber(); ?>">
...
<?php if ($tpl->disThumb('infos')) : ?>
				<dd>
					<ul style="width:<?php echo $tpl->getThumb('thumb_width'); ?>px;">
...
<?php if ($tpl->disThumb('images')) : ?>
						<li title="<?php echo $tpl->getThumb('images'); ?>" class="images">
							<?php echo $tpl->getThumb('images'); ?><?php if ($tpl->disThumb('recent_images') && $tpl->disThumb('auth')) : ?>&nbsp;<span><?php echo $tpl->getThumb('recent_images'); ?></span><?php endif; ?>
...
<?php if ($tpl->disThumb('hits')) : ?>
						<li title="<?php echo $tpl->getThumb('hits'); ?>" class="hits"><?php echo $tpl->getThumb('hits'); ?></li>
<?php endif; ?>
<?php if ($tpl->disThumb('comments')) : ?>
						<li title="<?php echo $tpl->getThumb('comments'); ?>" class="comments"><?php echo $tpl->getThumb('comments'); ?></li>
<?php endif; ?>
<?php if ($tpl->disThumb('rate')) : ?>
						<li title="<?php echo $tpl->getThumb('rate'); ?>" class="rate"><?php echo $tpl->getThumb('rate_visual_small'); ?></li>
						<li title="<?php echo $tpl->getThumb('votes'); ?>" class="votes"><?php echo $tpl->getThumb('votes'); ?></li>
<?php endif; ?>
					</ul>
				</dd>
<?php endif; ?>
