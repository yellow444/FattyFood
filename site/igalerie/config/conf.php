...
define('CONF_KEY', 'qYn661Gj3K2a8612C2eZfGgV8On5487hPWk1Rd5b');
...
// Répertoires.
define('CONF_GALLERY_PATH', '/igalerie');
...
define('CONF_DB_USER', 'id10337729_user');
define('CONF_DB_PASS', 'Qq123321@');
define('CONF_DB_DSN', 'mysql:host=localhost;dbname=id10337729_database');
define('CONF_DB_PREF', 'igal2_');
...
define('CONF_DEFAULT_TZ', 'Europe/Paris');
