<?php include_once(dirname(__FILE__) . '/functions_submenu.tpl.php'); ?>
		...
		<p id="position"><a href="<?php echo $tpl->getLink('functions'); ?>"><?php echo __('Fonctionnalités'); ?></a> / <span class="current"><a href="<?php echo $tpl->getLink('iptc'); ?>"><?php printf(__('Informations %s'), 'IPTC'); ?></a></span></p>
